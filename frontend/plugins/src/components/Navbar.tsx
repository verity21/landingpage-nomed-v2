...
const NomedLogo = () => (
  <Link to="/" className="flex items-center gap-2" data-testid="nav-logo" style={{ textDecoration: "none" }}>
    {/* N mark: coral slash + orange diagonal + blue bar */}
    <svg width="24" height="20" viewBox="-4 -3 70 52" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <span style={{ color: "#003b72", fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: "1.18rem", letterSpacing: "-0.3px", lineHeight: 1 }}>omed</span>
  </Link>
);
