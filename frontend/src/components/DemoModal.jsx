...
function LeftPanel({ selectedDate, selectedTime }) {
  return (
          ...
          <div className="flex-1 p-8 overflow-y-auto bg-white">
            {confirmed ? (
              ...
              <div data-testid="demo-step-1">
                ...
                <Calendar mode="single" selected={selectedDate} onSelect={handleDateSelect} disabled={isDisabled} className="rounded-xl border border-gray-100 w-full" />
              </div>
            ) : step === 2 ? (
