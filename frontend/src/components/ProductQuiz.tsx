...
export const PRODUCT_INFO: Record<string, { color: string; bg: string; border: string; tagline: string; desc: string; link: string }> = {
  Botbee: {
    color: "#fc5e5f", bg: "#fc5e5f10", border: "#fc5e5f30",
  ...
  Cert: {
    color: "#009ee7", bg: "#009ee710", border: "#009ee730",
  ...
  "Blog IA": {
    color: "#e8902f", bg: "#e8902f10", border: "#e8902f30",
  ...
  "ED Master": {
    color: "#FF7878", bg: "#FF787810", border: "#FF787830",
  ...
  "ED Teach": {
    color: "#65B4B8", bg: "#65B4B810", border: "#65B4B830",
  ...
  "ED Math": {
    color: "#2B7F87", bg: "#2B7F8710", border: "#2B7F8730",
...
function getRecommendation(allAnswerScores: Record<string, number>[]): string {
...
export default function ProductQuiz({ onContact }: ProductQuizProps) {
